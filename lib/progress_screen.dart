    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 12),
          _buildRecentTestItem('Speed Test', '2024-01-15', '12.5s'),
          _buildRecentTestItem('Endurance Test', '2024-01-15', '15 min'),
          _buildRecentTestItem('Flexibility Test', '2024-01-15', '8/10'),
        ],
      ),
    );
  }
